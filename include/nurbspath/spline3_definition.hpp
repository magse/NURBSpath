...
/**
 * @brief Owning, detached definition data for a 3D NURBS spline.
 *
 ...
 * invalid combination of fields. A `nurbs_spline3` constructor or
 * `set_definition` call validates the complete candidate before adopting it.
 *
 * @tparam REAL Floating-point scalar type.
 */
template <std::floating_point REAL>
struct spline3_definition {
    /** @brief Control points in the shared 3D world. */
