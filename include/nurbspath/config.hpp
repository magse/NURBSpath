 ...
 *
 * This source-tree header is the no-CMake fallback for release `v0.4.2`.
...
#define NURBSPATH_VERSION_STRING "0.4.2"

/** @brief Integer library version encoded as `major*10000 + minor*100 + patch`. */
#define NURBSPATH_VERSION_NUMBER 402
...
#define NURBSPATH_GIT_DESCRIBE "v0.4.2"
#endif
...
#define NURBSPATH_GIT_VERSION "0.4.2+v0.4.2"
#endif
