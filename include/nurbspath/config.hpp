 ...
 *
 * This source-tree header is the no-CMake fallback for release `v0.1.5`.
...
#define NURBSPATH_GIT_DESCRIBE "v0.1.5"
#endif
...
#define NURBSPATH_GIT_VERSION "0.1.5+v0.1.5"
#endif
