 ...
 *
 * This source-tree header is the no-CMake fallback for release `v0.4.1`.
...
#define NURBSPATH_GIT_DESCRIBE "v0.4.1"
#endif
...
#define NURBSPATH_GIT_VERSION "0.4.1+v0.4.1"
#endif
