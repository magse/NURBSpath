 ...
 *
 * This source-tree header is the no-CMake fallback for release `v0.1.1`.
...
#define NURBSPATH_VERSION_STRING "0.1.1"

/** @brief Integer library version encoded as `major*10000 + minor*100 + patch`. */
#define NURBSPATH_VERSION_NUMBER 101
...
#define NURBSPATH_GIT_DESCRIBE "v0.1.1"
#endif
...
#define NURBSPATH_GIT_VERSION "0.1.1+v0.1.1"
#endif
