...
int main() {
    ...
    static_assert(NURBSPATH_VERSION_MINOR == 2);
    static_assert(NURBSPATH_VERSION_PATCH == 1);
    static_assert(NURBSPATH_VERSION_NUMBER == 201);
    static_assert(NURBSPATH_CONFIG_GENERATED == 1);

    check(NURBSPATH_VERSION_STRING == "0.2.1"sv,
