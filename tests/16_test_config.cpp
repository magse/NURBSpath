...
int main() {
    ...
    static_assert(NURBSPATH_VERSION_MINOR == 4);
    static_assert(NURBSPATH_VERSION_PATCH == 0);
    static_assert(NURBSPATH_VERSION_NUMBER == 400);
    static_assert(NURBSPATH_CONFIG_GENERATED == 1);

    check(NURBSPATH_VERSION_STRING == "0.4.0"sv,
